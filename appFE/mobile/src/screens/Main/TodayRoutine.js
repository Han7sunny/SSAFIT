...
export default function TodayRoutine(props) {
  ...
  return (
    <View
      ...
      // onPress={() => navigation.navigate('Home', {screen:'RoutineDetailScreen'})}
    >
      ...
      <Button
        onPress={() =>
          navigation.navigate('Home', {screen: 'RoutineReservationScreen'})
        }>
        루틴 예약하러 가기
      </Button>

      {/* <Text style={styles.exercise}> {todayRoutine.routineName} </Text> */}
      <RoutineListItem routineId={props.exerciseId} name={props.routineName} />
      {/* <View>
        <View>
