...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable() // REST API는 UI를 사용하지 않으므로 기본설정을 비활성화
                ...
                .antMatchers("/api/user/check-code","/api/user/create-code","/api/user/find-password","/api/user/password-verification","/api/user/email-check","/api/user/name-check","/api/user/id-check","/api/user/findId","/api/user/join", "/api/user/login", "/api/swagger-ui/**","/api/swagger-ui.html").permitAll() // 가입 및 로그인 주소는 허용 ,"/sign-api/exception"
