...
//                .antMatchers("/routine/get-user-routine/{id}","/user/join", "/user/login", "/user/create-code", "/user/check-code", "/exercise/get-exercise-type", "/routine/generate-routine", "/routine/get-exercise-info/{id}", "/routine/modify-routine", "/routine/add-routine").permitAll() // 가입 및 로그인 주소는 허용 ,"/sign-api/exception"
